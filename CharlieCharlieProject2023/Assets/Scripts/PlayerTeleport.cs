...
public class PlayerTeleport : MonoBehaviour
{
    ...
    {   
        ...
        {  
            case 0 :
                gameObject.transform.position = new Vector2(TeleportPos[3].transform.position.x - 3, TeleportPos[3].transform.position.y);
                break;
            case 1 :
                gameObject.transform.position = new Vector2(TeleportPos[2].transform.position.x + 3, TeleportPos[2].transform.position.y);
                break;
            case 2 :
                gameObject.transform.position = new Vector2(TeleportPos[1].transform.position.x - 3, TeleportPos[1].transform.position.y);
                break;
            case 3 :
                gameObject.transform.position = new Vector2(TeleportPos[0].transform.position.x + 3, TeleportPos[0].transform.position.y);
                break;
        }
    }
}
